...
const statusBackgroundColorMap: StatusMap<string> = {
	ended: `linear-gradient(90deg, ${alpha(statusColorMap.ended, 0.3)} 0%, #151515 100%)`,
	playing: `linear-gradient(90deg, ${alpha(statusColorMap.playing, 0.3)} 0%, #151515 100%)`,
	waiting: `linear-gradient(90deg, ${alpha(statusColorMap.waiting, 0.3)} 0%, #151515 100%)`,
}
