...
const Dashboard: React.FC = () => {
	...
	const getGameList = async (shouldCancel: () => boolean) => {
	...
	const onGameListUpdated = (shouldCancel: () => boolean) => {
		return socket.onGameListUpdated(async () => {
			...
			await getGameList(shouldCancel)
	...
	useDidMount(() => {
		...
		getGameList(shouldCancel)
		const unsubscribe = onGameListUpdated(shouldCancel)
